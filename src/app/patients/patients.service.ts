...
export class PatientsService {
  ...
  private patients: Patient[] = [
    ...
    },
    {
      "id": "p2",
        ...
        "diagnosis": "Arthritis",
        "description": "Severe joint pain !!!! Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.",
        "bodyTemperature": 38,
        "pulseRate": 79,
        "respirationRate": 22,
		"systolicBP": 120,
    ...
    },
    {
      ...
      "title": "Olli Hamptonh",
        ...
        "description": "Clots developed in the lower leg!!!! Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.",
        "bodyTemperature": 34,
        "pulseRate": 89,
        "respirationRate": 16,
		"systolicBP": 80,
    ...
    },
    {
        ...
        "description": "Mild memory loss!!!! Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.",
        "bodyTemperature": 36,
        "pulseRate": 88,
        "respirationRate": 24,
		"systolicBP": 98,
  ...
  getAllPatient() {
    return [...this.patients] // Returnig copy of allPatients array
  }
  ...
  getPatient(patientId: string) {
    return {...this.patients.find(patient => { // pulling out all the properties of the allPatients object
